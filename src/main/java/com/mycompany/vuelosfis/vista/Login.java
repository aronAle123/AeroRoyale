...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText(PLACEHOLDER_USUARIO);
        ...
        jTextField2.setText(PLACEHOLDER_PASSWORD);

        jPanel2.setBackground(new java.awt.Color(0, 0, 128));

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("SISTEMA DE VUELOS");
        ...
        jLabel5.setText("Informacón");

        jLabel6.setText("Si es tu primera vez, haz click en \"Registrarse\" para crear una cuenta");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (usuario.equals(PLACEHOLDER_USUARIO) || password.equals(PLACEHOLDER_PASSWORD) || usuario.isEmpty() || password.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Por favor ingrese usuario y contraseña", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            AuthController authController = new AuthController();
            Usuario usuarioAutenticado = authController.login(usuario, password);
    ...
    private void configurarPlaceholders() {
        ...
        jTextField1.addFocusListener(new java.awt.event.FocusAdapter() {
            ...
            public void focusGained(java.awt.event.FocusEvent evt) {
                if (PLACEHOLDER_USUARIO.equals(jTextField1.getText())) {
                    jTextField1.setText("");
                }
            }
        ...
        jTextField2.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override
            public void focusGained(java.awt.event.FocusEvent evt) {
                String current = new String(jTextField2.getPassword());
            ...
            @Override
            public void focusLost(java.awt.event.FocusEvent evt) {
                String current = new String(jTextField2.getPassword()).trim();
                if (current.isEmpty()) {
                    jTextField2.setEchoChar((char) 0);
                    jTextField2.setText(PLACEHOLDER_PASSWORD);
                }
